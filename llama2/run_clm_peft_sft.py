...
from dataset_utils import build_instruction_dataset, DataCollatorForSupervisedDataset
...
def main():
    ...
    if (len(tokenizer)) != 55296:
        raise ValueError(
            f"The vocab size of the tokenizer should be 55296, but found {len(tokenizer)}.\n"
